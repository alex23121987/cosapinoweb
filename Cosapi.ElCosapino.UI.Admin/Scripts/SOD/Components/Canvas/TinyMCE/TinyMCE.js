...
/// </summary>
/// <remarks>
/// Creacion: 	Canvas(EJHF) 20150527 <br />
/// </remarks>
ns('Pe.Canvas.UI.Web.Components.TinyMCE');
Pe.Canvas.UI.Web.Components.TinyMCE = function (opts) {
    this.init(opts);
};

Pe.Canvas.UI.Web.Components.TinyMCE.prototype = {
    init: function (opts) {        
