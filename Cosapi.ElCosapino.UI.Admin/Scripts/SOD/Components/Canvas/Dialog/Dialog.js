...
/// </remarks>
ns('Pe.Canvas.UI.Web.Components.Dialog');
Pe.Canvas.UI.Web.Components.Dialog = function (opts) {
    //$.extend( {
    //    show: true,
    //    hide: true,
    //    width: '50%',
...
Pe.Canvas.UI.Web.Components.Dialog.prototype = {
    idDivDialog: 'divDialog_Canvas',
    ...
    getAjaxContent: function (opts) {
        ...
        var ajaxBuscar = new Pe.Canvas.UI.Web.Components.Ajax({
            ...
            onSuccess: function (html) {
                ...
                me.setContent(html);
                //Pe.Canvas.UI.Web.Components.TextBox.Function.Configure(me.idDivDialog);
                ...
                if (Pe.Canvas.UI.Web.Components.Util.RemoveDrop) {
                    Pe.Canvas.UI.Web.Components.Util.RemoveDrop();
                }
                setTimeout(function () {
                    if (opts.onSuccess) {
