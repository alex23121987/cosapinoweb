...
Pe.Canvas.UI.Web.Components.Ajax = function (opts) {
    this.init(opts);
};

Pe.Canvas.UI.Web.Components.Ajax.prototype = {
    ...
    //message: new Pe.Canvas.UI.Web.Components.Message(),
    processData: null,
    hasFile: null,
        ...
        this.ajaxRequest.done(function (data) {
            ...
            if ((data && data.IsSuccess === true) || me.dataType.toUpperCase() == 'HTML') {
                ...
                if (data.Exception && data.Exception.IsCustomException) {
                    alert("Mensaje de alerta", data.Exception.Message);
                }
                else {
                    ...
                    alert("Error", 'Error al procesar la solicitud, el proceso retorno : IsSuccess="false"; Validar la ejecucion del proceso en el servidor. (AjaxUtil.ajaxRequest.done -> ' + data.Exception.Message + ')')
                }
    ...
    implementLoading: function () {
        ///this.loading = new Pe.Canvas.UI.Web.Components.ProgressBar({ renderizarEn: this.targetLoading });
    },
