...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            successfullyClass: "ajax-file-upload-successfully",
            ...
            sizeErrorStr: "no está permitido. El tamaño máximo permitido : ",
            uploadErrorStr: "Upload is not allowed",
            maxFileCountErrorStr: "no está permitido. El número máximo de archivos permitidos son:",
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            $('<a class="btn btn-primary">Adjuntar <i class="glyphicon glyphicon-paperclip"></i></a>').appendTo(form);
            ...
            var options = {
                ...
                success: function (data, message, xhr) {
                    ...
                    if (s.showStatusAfterSuccess) {
                      ...
                      /*  pd.statusbar.hide("slow");
                        pd.statusbar.remove();*/
                        pd.progressDiv.hide();
                        pd.statusbar.append("<span class='" + s.successfullyClass + "'>Carga Satisfactoria </span>");
                    }
                    if (s.showDownload) {
                        pd.download.show();
                        pd.download.click(function () {
                ...
                error: function (xhr, status, errMsg) {
                    ...
                    if (xhr.statusText == "abort") //we aborted it
                    {
                        ...
                        s.onError.call(this, fileArray, status, xhr.responseText, pd);
                        if (s.showStatusAfterError) {
                            pd.progressDiv.hide();
                            pd.statusbar.append("<span class='" + s.errorClass + "'>ERROR: " + xhr.responseText + "</span>");
                        } else {
                            pd.statusbar.hide();
                            pd.statusbar.remove();
                        }
