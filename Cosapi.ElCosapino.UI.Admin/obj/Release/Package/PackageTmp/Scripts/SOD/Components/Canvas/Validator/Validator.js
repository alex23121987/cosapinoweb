...
ns('Pe.Canvas.UI.Web.Components.Validator.Resources');
Pe.Canvas.UI.Web.Components.Validator.Resources.LabelTitleSummary = 'Debe ingresar';
...
/// </remarks>
ns('Pe.Canvas.UI.Web.Components.Validator');
Pe.Canvas.UI.Web.Components.Validator = function (opts) {
    this.init(opts);
};

Pe.Canvas.UI.Web.Components.Validator.prototype = {
    form: null,
    ...
    init: function (opts) {
        if (opts) {
            ...
            if (this.form != null) {
                ...
                //this.errorMessage = new Pe.Canvas.UI.Web.Components.Message();
    ...
    generateSummaryError: function () {
        ...
        //var summaryHtml = Pe.Canvas.UI.Web.Components.Validator.Resources.LabelTitleSummary + ' ';
        var summaryHtml = "Verificar";
        var valid = true;
        var base = this;
        ...
        if (this.validator.errorList.length > 0) {
            for (var i = 0; i < this.validator.errorList.length; i++) {
                ...
                if (summaryHtml.indexOf(error.message) == -1) {
                    if (i == 0) {
        ...
        if (!valid && this.showSummary) {
            ...
            this.form.after(divErrorMessage);
