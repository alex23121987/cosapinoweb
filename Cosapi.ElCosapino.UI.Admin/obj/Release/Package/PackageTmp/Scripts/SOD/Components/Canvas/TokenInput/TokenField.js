...
/// </summary>
/// <remarks>
/// Creacion: 	Canvas(GRC) 20150422
/// </remarks>
ns('Pe.Canvas.UI.Web.Components.TokenField');
Pe.Canvas.UI.Web.Components.TokenField = function (opts) {
    this.init(opts);
};

Pe.Canvas.UI.Web.Components.TokenField.prototype = {
    target: null,
    data: null,
    //value: null,
    prePopulate: null,
