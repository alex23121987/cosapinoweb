...
Pe.Canvas.UI.Web.Components.ProgressBar = function (opts) {
    this.init(opts);
};

Pe.Canvas.UI.Web.Components.ProgressBar.prototype = {
    idDivProgrees: 'divProgressBar_Canvas',
    idDivDialog: 'divProgressDialogBar_Canvas',
